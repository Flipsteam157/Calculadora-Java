...
public class Calculadora extends javax.swing.JFrame {
    ...
    public Eval eval;
    public int paridadeParenteses;
    
    /** Creates new form Calculadora */
    public Calculadora() {
        initComponents();
        Eval eval = new Eval();
        paridadeParenteses = 0;
    }
    ...
    public void calcularResultado(){
        ...
        try {
            if (formula.contains("=") || formula.contains("<") || formula.contains(">")){
                double resultado = eval.avaliarExpressao(formula);
                if (resultado == 1.0){
                    jTextField1.setText("Resultado: " + "Verdadeiro");
                }
                else{
                    jTextField1.setText("Resultado: " + "Falso");
                }
            }
            else{
                double resultado = eval.avaliarExpressao(formula);
            ...
            jTextField1.setText("Erro ao avaliar a expressão.");
        }
    }
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        if (tamanho != 0){
            if (conteudo.charAt(tamanho - 1) == '(' || conteudo.charAt(tamanho - 1) == ')') {
                paridadeParenteses--;
            }
            jTextField1.setText(conteudo.substring(0, tamanho - 1));
        }
